...
def species_dat_replacer(ovl, name_tups):
	...
	if ovl.user_version.is_jwe:
		...
		name_tups_new = [(old_a, new_a), (old_af, new_af), (old_aj, new_aj), (old_am, new_am),
						 (old_l0, new_l0), (old_l0f, new_l0f), (old_l0j, new_l0j), (old_l0m, new_l0m),
						 (old_l0h, new_l0h), (old_l0fh, new_l0fh), (old_l0jh, new_l0jh), (old_l0mh, new_l0mh),
						 (old_l1, new_l1), (old_l1f, new_l1f), (old_l1j, new_l1j), (old_l1m, new_l1m),
						 (old_l1h, new_l1h), (old_l1fh, new_l1fh), (old_l1jh, new_l1jh), (old_l1mh, new_l1mh),
						 (old_l2, new_l2), (old_l2f, new_l2f), (old_l2j, new_l2j), (old_l2m, new_l2m),
						 (old_l2h, new_l2h), (old_l2fh, new_l2fh), (old_l2jh, new_l2jh), (old_l2mh, new_l2mh),
						 (old_l3, new_l3), (old_l3f, new_l3f), (old_l3j, new_l3j), (old_l3m, new_l3m),
						 (old_l3h, new_l3h), (old_l3fh, new_l3fh), (old_l3jh, new_l3jh), (old_l3mh, new_l3mh),
						 (old_l4, new_l4), (old_l4f, new_l4f), (old_l4j, new_l4j), (old_l4m, new_l4m),
						 (old_l4h, new_l4h), (old_l4fh, new_l4fh), (old_l4jh, new_l4jh), (old_l4mh, new_l4mh),
						 (old_l5, new_l5), (old_l5f, new_l5f), (old_l5j, new_l5j), (old_l5m, new_l5m),
						 (old_l5h, new_l5h), (old_l5fh, new_l5fh), (old_l5jh, new_l5jh), (old_l5mh, new_l5mh),
						 (old_l6, new_l6), (old_l6f, new_l6f), (old_l6j, new_l6j), (old_l6m, new_l6m),
						 (old_l6h, new_l6h), (old_l6fh, new_l6fh), (old_l6jh, new_l6jh), (old_l6mh, new_l6mh),
						 (old_b, new_b), (old_bf, new_bf), (old_bj, new_bj), (old_bm, new_bm), (old_bh, new_bh),
						 (old_bfh, new_bfh), (old_bjh, new_bjh), (old_bmh, new_bmh),
						 (old_c, new_c), (old_cf, new_cf), (old_cj, new_cj), (old_cm, new_cm), (old_ch, new_ch),
						 (old_cfh, new_cfh), (old_cjh, new_cjh), (old_cmh, new_cmh),
						 (old_d, new_d), (old_df, new_df), (old_dj, new_dj), (old_dm, new_dm), (old_dh, new_dh),
						 (old_dfh, new_dfh), (old_djh, new_djh), (old_dmh, new_dmh),
						 (old_e, new_e), (old_ef, new_ef), (old_ej, new_ej), (old_em, new_em), (old_eh, new_eh),
						 (old_efh, new_efh), (old_ejh, new_ejh), (old_emh, new_emh),
						 (old_f, new_f), (old_ff, new_ff), (old_fj, new_fj), (old_fm, new_fm), (old_fh, new_fh),
						 (old_ffh, new_ffh), (old_fjh, new_fjh), (old_fmh, new_fmh),
						 (old_g, new_g), (old_gf, new_gf), (old_gj, new_gj), (old_gm, new_gm), (old_gh, new_gh),
						 (old_gfh, new_gfh), (old_gjh, new_gjh), (old_gmh, new_gmh),
						 (old_h, new_h), (old_hf, new_hf), (old_hj, new_hj), (old_hm, new_hm), (old_hh, new_hh),
						 (old_hfh, new_hfh), (old_hjh, new_hjh), (old_hmh, new_hmh),
						 (old_i, new_i), (old_if, new_if), (old_ij, new_ij), (old_im, new_im), (old_ih, new_ih),
						 (old_ifh, new_ifh), (old_ijh, new_ijh), (old_imh, new_imh),
						 (old_j, new_j), (old_jf, new_jf), (old_jj, new_jj), (old_jm, new_jm), (old_jh, new_jh),
						 (old_jfh, new_jfh), (old_jjh, new_jjh), (old_jmh, new_jmh),
						 (old_k, new_k), (old_kf, new_kf), (old_kj, new_kj), (old_km, new_km), (old_kh, new_kh),
						 (old_kfh, new_kfh), (old_kjh, new_kjh), (old_kmh, new_kmh),
						 (old_l, new_l), (old_lf, new_lf), (old_lj, new_lj), (old_lm, new_lm), (old_lh, new_lh),
						 (old_lfh, new_lfh), (old_ljh, new_ljh), (old_lmh, new_lmh),
						 (old_m, new_m), (old_mf, new_mf), (old_mj, new_mj), (old_mm, new_mm), (old_mh, new_mh),
						 (old_mfh, new_mfh), (old_mjh, new_mjh), (old_mmh, new_mmh),
						 (old_n, new_n), (old_nf, new_nf), (old_nj, new_nj), (old_nm, new_nm), (old_nh, new_nh),
						 (old_nfh, new_nfh), (old_njh, new_njh), (old_nmh, new_nmh),
						 (old_o, new_o), (old_of, new_of), (old_oj, new_oj), (old_om, new_om), (old_oh, new_oh),
						 (old_ofh, new_ofh), (old_ojh, new_ojh), (old_omh, new_omh)]
	try:
		# hash the internal buffers
		for archive_entry in ovl.archives:
			ovs = archive_entry.content
