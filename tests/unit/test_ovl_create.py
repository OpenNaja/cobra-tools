...
class TestOVLCreate:
	...
	def test_ovl_create_pc(self, ovl_file: OvlFile):
		game = "Planet Coaster"
		file = 'tests/tmp/pc.ovl'
		set_game(ovl_file.context, game)
		set_game(ovl_file, game)
		ovl_file.create('tests/Files/')
		ovl_file.save(file)
		ovl_file.load(file)
		assert game == get_game(ovl_file)[0].value

	def test_ovl_create_pz(self, ovl_file: OvlFile):
		game = "Planet Zoo"
	...
	def test_ovl_create_jwe1(self, ovl_file: OvlFile):
	...
	def test_ovl_create_jwe2(self, ovl_file: OvlFile):
