...
class TerrainIndexedDetailLayersRoot(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('layer_list', ArrayPointer, (None, TerrainIndexedDetailLayersRoot._import_map["terrainindexeddetaillayers.compounds.TerrainDetailsLayerItem"]), (False, None), None)
