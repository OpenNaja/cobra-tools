...
class NextRow2(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.unk_13 = name_type_map['Ushort'](self.context, 0, None)
		self.unk_14 = name_type_map['Ushort'](self.context, 0, None)
		self.unk_15 = name_type_map['Ushort'](self.context, 0, None)
		self.unk_16 = name_type_map['Ushort'](self.context, 0, None)
		if set_default:
			self.set_defaults()
	...
	def _get_attribute_list(cls):
		...
		yield 'unk_13', name_type_map['Ushort'], (0, None), (False, None), (None, None)
		yield 'unk_14', name_type_map['Ushort'], (0, None), (False, None), (None, None)
		yield 'unk_15', name_type_map['Ushort'], (0, None), (False, None), (None, None)
		yield 'unk_16', name_type_map['Ushort'], (0, None), (False, None), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'unk_13', name_type_map['Ushort'], (0, None), (False, None)
		yield 'unk_14', name_type_map['Ushort'], (0, None), (False, None)
		yield 'unk_15', name_type_map['Ushort'], (0, None), (False, None)
		yield 'unk_16', name_type_map['Ushort'], (0, None), (False, None)
