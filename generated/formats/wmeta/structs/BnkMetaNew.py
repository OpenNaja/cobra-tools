...
class BnkMetaNew(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield 'fnv', name_type_map['Uint'], (0, None), (False, None), (lambda context: context.is_pz, None)
		...
		yield 'fnv', name_type_map['Uint'], (0, None), (False, None), (lambda context: not context.is_pz, None)
