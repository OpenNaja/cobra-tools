...
class Bone(BaseStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.rot = name_type_map['Vector3Ushort'](self.context, 0, None)
	...
	def _get_attribute_list(cls):
		...
		yield 'rot', name_type_map['Vector3Ushort'], (0, None), (False, None), (None, None)
		yield 'loc', name_type_map['Vector3Ushort'], (0, None), (False, None), (None, None)

	@classmethod
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		yield from super()._get_filtered_attribute_list(instance, include_abstract)
		yield 'rot', name_type_map['Vector3Ushort'], (0, None), (False, None)
