...
class BaniGpuChannelsLod(BaseStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		# 32 for small skeleton LOD channels
		self.padding = name_type_map['PadAlignFF'](self.context, 32, self.ref)
		if set_default:
			self.set_defaults()
	...
	def _get_attribute_list(cls):
		...
		yield 'padding', name_type_map['PadAlignFF'], (32, None), (False, None), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'padding', name_type_map['PadAlignFF'], (32, instance.ref), (False, None)
