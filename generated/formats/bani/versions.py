...
jwe = BaniVersion(id='JWE', version=(5,), primary_games=[], all_games=[games.JURASSIC_WORLD_EVOLUTION])
jwe2 = BaniVersion(id='JWE2', version=(5,), primary_games=[], all_games=[games.JURASSIC_WORLD_EVOLUTION_2])
...
jwe3 = BaniVersion(id='JWE3', version=(7,), primary_games=[], all_games=[games.JURASSIC_WORLD_EVOLUTION_3])
pc = BaniVersion(id='PC', version=(2,), primary_games=[], all_games=[games.PLANET_COASTER])
pc2 = BaniVersion(id='PC2', version=(7,), primary_games=[], all_games=[games.PLANET_COASTER_2])
pz = BaniVersion(id='PZ', version=(5,), primary_games=[], all_games=[games.PLANET_ZOO])
...
war = BaniVersion(id='WAR', version=(5,), primary_games=[], all_games=[games.WARHAMMER_AGE_OF_SIGMAR_REALMS_OF_RUIN])
