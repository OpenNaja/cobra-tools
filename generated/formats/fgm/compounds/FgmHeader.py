...
class FgmHeader(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('textures', ArrayPointer, (None, FgmHeader._import_map["fgm.compounds.TextureInfo"]), (False, None), None)
		yield ('attributes', ArrayPointer, (None, FgmHeader._import_map["fgm.compounds.AttribInfo"]), (False, None), None)
		yield ('name_foreach_textures', ForEachPointer, (None, FgmHeader._import_map["fgm.compounds.TextureData"]), (False, None), None)
		yield ('value_foreach_attributes', ForEachPointer, (None, FgmHeader._import_map["fgm.compounds.AttribData"]), (False, None), None)
