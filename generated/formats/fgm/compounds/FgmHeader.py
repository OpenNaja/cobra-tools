...
class FgmHeader(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('attributes', name_type_map['ArrayPointer'], (None, None), (False, None), (None, None))
		yield ('name_foreach_textures', name_type_map['ForEachPointer'], (None, None), (False, None), (None, None))
		yield ('value_foreach_attributes', name_type_map['ForEachPointer'], (None, None), (False, None), (None, None))
