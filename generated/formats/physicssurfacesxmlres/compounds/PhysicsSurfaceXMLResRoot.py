...
class PhysicsSurfaceXMLResRoot(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('ptr_1', Pointer, (0, PhysicsSurfaceXMLResRoot._import_map["physicssurfacesxmlres.compounds.EmptyStruct"]), (False, None), None)
		yield ('ptr_2', ArrayPointer, (None, PhysicsSurfaceXMLResRoot._import_map["physicssurfacesxmlres.compounds.SurfacePhysicsInfo"]), (False, None), None)
