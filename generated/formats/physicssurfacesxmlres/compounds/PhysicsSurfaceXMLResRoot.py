...
class PhysicsSurfaceXMLResRoot(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('default_surface_name', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		...
		yield ('name_1', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('name_2', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('ptr_1', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('ptr_2', name_type_map['ArrayPointer'], (None, None), (False, None), (None, None))
