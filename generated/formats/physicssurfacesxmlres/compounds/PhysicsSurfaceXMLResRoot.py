...
class PhysicsSurfaceXMLResRoot(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('default_surface_name', Pointer, (0, ZString), (False, None), (None, None))
		...
		yield ('ptr_1', Pointer, (0, PhysicsSurfaceXMLResRoot._import_map["physicssurfacesxmlres.compounds.EmptyStruct"]), (False, None), (None, None))
		yield ('ptr_2', ArrayPointer, (None, PhysicsSurfaceXMLResRoot._import_map["physicssurfacesxmlres.compounds.SurfacePhysicsInfo"]), (False, None), (None, None))
		yield ('count', Ushort, (0, None), (False, None), (None, None))
		yield ('short_2', Ushort, (0, None), (False, None), (None, None))
		...
		yield ('unk_64_7', Uint64, (0, None), (False, None), (None, None))
		yield ('unk_64_8', Uint64, (0, None), (False, None), (None, None))
		yield ('unk_64_9', Uint64, (0, None), (False, None), (None, None))
		yield ('unk_64_10', Uint64, (0, None), (False, None), (None, None))
