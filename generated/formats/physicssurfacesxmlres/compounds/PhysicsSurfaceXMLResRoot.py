...
class PhysicsSurfaceXMLResRoot(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.ptr_1 = name_type_map['Pointer'](self.context, self.count, None)
		self.ptr_2 = name_type_map['ArrayPointer'](self.context, self.count_2, name_type_map['Struct2'])
		self.ptr_4 = name_type_map['ArrayPointer'](self.context, self.count_3, name_type_map['Struct3'])
		if set_default:
			self.set_defaults()
	...
	def _get_attribute_list(cls):
		...
		yield 'ptr_1', name_type_map['Pointer'], (None, None), (False, None), (None, None)
		yield 'count', name_type_map['Uint64'], (0, None), (False, None), (None, None)
		yield 'ptr_2', name_type_map['ArrayPointer'], (None, name_type_map['Struct2']), (False, None), (None, None)
		yield 'count_2', name_type_map['Uint64'], (0, None), (False, None), (None, None)
		yield 'ptr_4', name_type_map['ArrayPointer'], (None, name_type_map['Struct3']), (False, None), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'ptr_1', name_type_map['Pointer'], (instance.count, None), (False, None)
		yield 'count', name_type_map['Uint64'], (0, None), (False, None)
		yield 'ptr_2', name_type_map['ArrayPointer'], (instance.count_2, name_type_map['Struct2']), (False, None)
		yield 'count_2', name_type_map['Uint64'], (0, None), (False, None)
		yield 'ptr_4', name_type_map['ArrayPointer'], (instance.count_3, name_type_map['Struct3']), (False, None)
