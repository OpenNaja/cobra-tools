...
class HabitatBoundaryDataRoot(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('prefab', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('walls_extrusion', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('walls_extrusion_end', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('walls_extrusion_top', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('walls_extrusion_cap_top', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('walls_extrusion_bottom', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('walls_unk_2', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('walls_unk_3', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('walls_unk_4', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('walls_extrusion_door_cap_side', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('walls_extrusion_door_cap_end', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('walls_extrusion_door_cap_underside', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('climb_proof_data', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('broken_post', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('broken_extrusion', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('broken_extrusion_pile', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('broken_ground', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('broken_1_m', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('broken_10_m', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('post', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('post_cap', name_type_map['Pointer'], (0, None), (False, None), (None, None))
