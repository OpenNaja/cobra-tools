...
class HabitatBoundaryPropRoot(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('type', Uint64, (0, None), (False, None), (None, None))
		...
		yield ('wall', Pointer, (0, ZString), (False, None), (None, None))
		yield ('is_guest', Uint, (0, None), (False, None), (None, None))
		yield ('post_position', HbPostPos, (0, None), (False, None), (None, None))
		yield ('u_2', Float, (0, None), (False, None), (None, None))
		yield ('door_physics', HbPropPhysics, (0, None), (False, None), (None, None))
		yield ('path_physics', HbPropPhysics, (0, None), (False, None), (None, None))
		yield ('path_join_part', Pointer, (0, ZString), (False, None), (None, None))
		yield ('door_cutout', HbDoorCutout, (0, None), (False, None), (None, None))
		yield ('small', Uint, (0, None), (False, None), (None, None))
		yield ('height', Float, (0, None), (False, 2.0), (None, None))
