...
class RideAnims(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield 'floats', Array, (0, None, (7,), name_type_map['Float']), (False, None), (lambda context: context.version == 18, None)
		yield 'bools', Array, (0, None, (56,), name_type_map['Ubyte']), (False, None), (lambda context: not (context.version == 18), None)
		yield 'floats', Array, (0, None, (2,), name_type_map['Float']), (False, None), (lambda context: not (context.version == 18), None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		if not (instance.context.version == 18):
			...
			yield 'floats', Array, (0, None, (2,), name_type_map['Float']), (False, None)
