...
class Ms2BufferInfoZT:
	...
	def read_fields(cls, stream, instance):
		instance.streams = Array.from_stream(stream, (instance.arg.general_info.vertex_buffer_count,), StreamInfo, instance.context, 0, None)

	@classmethod
	def write_fields(cls, stream, instance):
		Array.to_stream(stream, instance.streams, (instance.arg.general_info.vertex_buffer_count,), StreamInfo, instance.context, 0, None)
