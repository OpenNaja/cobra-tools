...
class HitCheck(BaseStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('dtype', CollisionType, (0, None), (False, None), (None, None))
		yield ('flag_0', Ushort, (0, None), (False, 0), (None, None))
		yield ('flag_1', Ushort, (0, None), (False, 0), (None, None))
		yield ('collision_layers', Uint64, (0, None), (False, None), (lambda context: context.version <= 47, None))
		yield ('collision_ignore', OffsetString, (None, None), (False, None), (lambda context: context.version >= 48, None))
		yield ('collision_use', OffsetString, (None, None), (False, None), (lambda context: context.version >= 48, None))
		yield ('zero_extra_pc', Uint, (0, None), (False, None), (lambda context: context.version <= 32, None))
		yield ('name', OffsetString, (None, None), (False, None), (None, None))
		yield ('collider', Sphere, (0, None), (False, None), (None, True))
		yield ('collider', BoundingBox, (0, None), (False, None), (None, True))
		yield ('collider', Capsule, (0, None), (False, None), (None, True))
		yield ('collider', Cylinder, (0, None), (False, None), (None, True))
		yield ('collider', ConvexHull, (0, None), (False, None), (None, True))
		yield ('collider', ConvexHull, (0, None), (False, None), (None, True))
		yield ('collider', MeshCollision, (0, None), (False, None), (None, True))
		yield ('zero_extra_zt', Uint, (0, None), (False, None), (lambda context: context.version == 13, None))
