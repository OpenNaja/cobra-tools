...
class ModelInfo(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('materials', ArrayPointer, (None, ModelInfo._import_map["ms2.compounds.MaterialName"]), (False, None), None)
		yield ('lods', ArrayPointer, (None, ModelInfo._import_map["ms2.compounds.LodInfo"]), (False, None), None)
		yield ('objects', ArrayPointer, (None, ModelInfo._import_map["ms2.compounds.Object"]), (False, None), None)
		yield ('meshes', ArrayPointer, (None, ModelInfo._import_map["ms2.compounds.MeshDataWrap"]), (False, None), None)
