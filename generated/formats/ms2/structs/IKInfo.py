...
class IKInfo(BaseStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.padding_jwe_3 = Array(self.context, 0, None, (0,), name_type_map['Uint64'])
	...
	def _get_attribute_list(cls):
		...
		yield 'padding_jwe_3', Array, (0, None, (3,), name_type_map['Uint64']), (False, None), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'padding_jwe_3', Array, (0, None, (3,), name_type_map['Uint64']), (False, None)
