...
games = ['Disneyland Adventure', 'Jurassic World Evolution', 'Old', 'Planet Coaster', 'Planet Zoo 1.6+', 'Planet Zoo pre-1.6', 'Zoo Tycoon Ultimate Animal Collection', 'Unknown Game']
