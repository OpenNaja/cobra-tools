...
class UiMovieHeader(MemStruct):
	...
	def _get_filtered_attribute_list(cls, instance):
		...
		yield ('ui_triggers', Pointer, (instance.num_ui_triggers, generated.formats.uimoviedefinition.compounds.PtrList.PtrList))
		yield ('ptr_1', Pointer, (0, None))
		yield ('ui_names', Pointer, (instance.num_ui_names, generated.formats.uimoviedefinition.compounds.PtrList.PtrList))
		yield ('assetpkgs', Pointer, (instance.num_assetpkgs, generated.formats.uimoviedefinition.compounds.PtrList.PtrList))
		...
		yield ('ui_interfaces', Pointer, (instance.num_ui_interfaces, generated.formats.uimoviedefinition.compounds.PtrList.PtrList))
