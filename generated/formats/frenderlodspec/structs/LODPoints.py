...
class LODPoints(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield 'discard_at_lod', name_type_map['Ushort'], (0, None), (False, None), (lambda context: not ((context.version == 18) or (context.user_version.use_djb and (context.version == 19))), None)
		yield 'max_lods', name_type_map['Ushort'], (0, None), (False, 6), (lambda context: not ((context.version == 18) or (context.user_version.use_djb and (context.version == 19))), None)
