...
class LODGroup(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield 'sub_lod_points_count', name_type_map['Uint'], (0, None), (False, 0), (lambda context: not ((context.version == 32) or ((context.version == 47) or (context.version == 39))), None)
		yield 'sub_lod_points', name_type_map['ArrayPointer'], (None, name_type_map['LODPoints']), (False, None), (lambda context: not ((context.version == 32) or ((context.version == 47) or (context.version == 39))), None)
