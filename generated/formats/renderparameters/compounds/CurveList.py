...
class CurveList(MemStruct):
	...
	def read_fields(cls, stream, instance):
		...
		instance.ptrs = Array.from_stream(stream, instance.context, 0, CurveList._import_path_map["generated.formats.renderparameters.compounds.KeyPoint"], (instance.arg,), Pointer)
