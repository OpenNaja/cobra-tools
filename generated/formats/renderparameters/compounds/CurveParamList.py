...
class CurveParamList(MemStruct):
	...
	def read_fields(cls, stream, instance):
		...
		instance.ptrs = Array.from_stream(stream, (instance.arg,), Pointer, instance.context, 0, generated.formats.renderparameters.compounds.CurveParam.CurveParam)
		instance.ptrs.arg = 0
	...
	def _get_filtered_attribute_list(cls, instance):
		...
		yield ('ptrs', Array, ((instance.arg,), Pointer, 0, generated.formats.renderparameters.compounds.CurveParam.CurveParam))
