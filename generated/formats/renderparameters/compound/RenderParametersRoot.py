...
import generated.formats.renderparameters.compound.ParamList
...
class RenderParametersRoot(MemStruct):
	...
	def read_fields(cls, stream, instance):
		...
		instance.params = Pointer.from_stream(stream, instance.context, instance.count, generated.formats.renderparameters.compound.ParamList.ParamList)
	...
	def _get_filtered_attribute_list(cls, instance):
		...
		yield ('params', Pointer, (instance.count, generated.formats.renderparameters.compound.ParamList.ParamList))
