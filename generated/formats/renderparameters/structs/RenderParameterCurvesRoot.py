...
class RenderParameterCurvesRoot(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.params = name_type_map['Pointer'](self.context, self.params_count, name_type_map['CurveParamList'])
		if set_default:
			self.set_defaults()
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'params', name_type_map['Pointer'], (instance.params_count, name_type_map['CurveParamList']), (False, None)
