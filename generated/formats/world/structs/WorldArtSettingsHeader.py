...
class WorldArtSettingsHeader(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.full_scale_material_name = name_type_map['Pointer'](self.context, 0, name_type_map['ZString'])
		...
		self.land_scape_prefab_name = name_type_map['Pointer'](self.context, 0, name_type_map['ZString'])
	...
	def _get_attribute_list(cls):
		...
		yield 'full_scale_material_name', name_type_map['Pointer'], (0, name_type_map['ZString']), (False, None), (None, None)
		...
		yield 'land_scape_prefab_name', name_type_map['Pointer'], (0, name_type_map['ZString']), (False, None), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'full_scale_material_name', name_type_map['Pointer'], (0, name_type_map['ZString']), (False, None)
		...
		yield 'land_scape_prefab_name', name_type_map['Pointer'], (0, name_type_map['ZString']), (False, None)
