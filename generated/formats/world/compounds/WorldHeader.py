...
class WorldHeader(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('asset_pkgs', Pointer, (None, WorldHeader._import_map["world.compounds.PtrList"]), (False, None), None)
		...
		yield ('prefabs', Pointer, (None, WorldHeader._import_map["world.compounds.PtrList"]), (False, None), None)
