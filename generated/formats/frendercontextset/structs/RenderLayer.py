...
class RenderLayer(MemStruct):
	...
	__name__ = 'RenderLayer'


	def __init__(self, context, arg=0, template=None, set_default=True):
		super().__init__(context, arg, template, set_default=False)
		self.layer_id = name_type_map['Uint64'](self.context, 0, None)
	...
	def _get_attribute_list(cls):
		...
		yield 'layer_id', name_type_map['Uint64'], (0, None), (False, None), (None, None)

	@classmethod
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		yield from super()._get_filtered_attribute_list(instance, include_abstract)
		yield 'layer_name', name_type_map['Pointer'], (0, name_type_map['ZString']), (False, None)
		yield 'layer_id', name_type_map['Uint64'], (0, None), (False, None)
