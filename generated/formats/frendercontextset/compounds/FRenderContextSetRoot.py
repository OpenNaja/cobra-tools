...
class FRenderContextSetRoot(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('ptr_1_list', name_type_map['ArrayPointer'], (None, None), (False, None), (None, None))
		yield ('ptr_1_count', name_type_map['Uint64'], (0, None), (False, None), (None, None))
		yield ('ptr_2_list', name_type_map['ArrayPointer'], (None, None), (False, None), (None, None))
		yield ('ptr_2_count', name_type_map['Uint64'], (0, None), (False, None), (None, None))
		yield ('ptr_3_list', name_type_map['ArrayPointer'], (None, None), (False, None), (None, None))
