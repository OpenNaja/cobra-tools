...
class ContextSet1Item(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('stuff_11_sub', ArrayPointer, (None, ContextSet1Item._import_map["frendercontextset.compounds.ContextSet1SubItem"]), (False, None), None)
		yield ('stuff_11_sub_count', Uint64, (0, None), (False, None), None)
		yield ('stuff_12_sub', ArrayPointer, (None, ContextSet1Item._import_map["frendercontextset.compounds.ContextSet1SubItem"]), (False, None), None)
		yield ('stuff_12_sub_count', Uint64, (0, None), (False, None), None)
		yield ('stuff_13_sub', ArrayPointer, (None, ContextSet1Item._import_map["frendercontextset.compounds.ContextSet1SubItem"]), (False, None), None)
