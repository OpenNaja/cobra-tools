...
class ManiBlock(BaseStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('pos_bones', Array, (0, None, (None,), Channelname), (False, None), (None, None))
		yield ('ori_bones', Array, (0, None, (None,), Channelname), (False, None), (None, None))
		yield ('scl_bones', Array, (0, None, (None,), Channelname), (False, None), (None, None))
		yield ('floats', Array, (0, None, (None,), Channelname), (False, None), (None, None))
		yield ('pos_bones_p', Array, (0, None, (None,), Ubyte), (False, None), (None, None))
		yield ('ori_bones_p', Array, (0, None, (None,), Ubyte), (False, None), (None, None))
		yield ('scl_bones_p', Array, (0, None, (None,), Ubyte), (False, None), (None, None))
		yield ('pos_bones_delta', Array, (0, None, (None,), Ubyte), (False, None), (None, True))
		yield ('ori_bones_delta', Array, (0, None, (None,), Ubyte), (False, None), (None, True))
		yield ('scl_bones_delta', Array, (0, None, (None,), Ubyte), (False, None), (None, True))
		yield ('pad', PadAlign, (4, None), (False, None), (None, None))
		yield ('key_data', UncompressedManiData, (None, None), (False, None), (None, True))
		yield ('key_data', CompressedManiData, (None, None), (False, None), (None, True))
