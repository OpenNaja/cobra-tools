...
class ManiBlock(BaseStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.pos_channel_to_bone = Array(self.context, 0, None, (0,), name_type_map['Ubyte'])
		self.ori_channel_to_bone = Array(self.context, 0, None, (0,), name_type_map['Ubyte'])
		self.scl_channel_to_bone = Array(self.context, 0, None, (0,), name_type_map['Ubyte'])
		self.pos_bone_to_channel = Array(self.context, 0, None, (0,), name_type_map['Ubyte'])
		self.ori_bone_to_channel = Array(self.context, 0, None, (0,), name_type_map['Ubyte'])
		self.scl_bone_to_channel = Array(self.context, 0, None, (0,), name_type_map['Ubyte'])
	...
	def _get_attribute_list(cls):
		...
		yield 'pos_channel_to_bone', Array, (0, None, (None,), name_type_map['Ubyte']), (False, None), (None, None)
		yield 'ori_channel_to_bone', Array, (0, None, (None,), name_type_map['Ubyte']), (False, None), (None, None)
		yield 'scl_channel_to_bone', Array, (0, None, (None,), name_type_map['Ubyte']), (False, None), (None, None)
		yield 'pos_bone_to_channel', Array, (0, None, (None,), name_type_map['Ubyte']), (False, None), (None, True)
		yield 'ori_bone_to_channel', Array, (0, None, (None,), name_type_map['Ubyte']), (False, None), (None, True)
		yield 'scl_bone_to_channel', Array, (0, None, (None,), name_type_map['Ubyte']), (False, None), (None, True)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'pos_channel_to_bone', Array, (0, None, (instance.arg.pos_bone_count,), name_type_map['Ubyte']), (False, None)
		yield 'ori_channel_to_bone', Array, (0, None, (instance.arg.ori_bone_count,), name_type_map['Ubyte']), (False, None)
		yield 'scl_channel_to_bone', Array, (0, None, (instance.arg.scl_bone_count,), name_type_map['Ubyte']), (False, None)
		if instance.arg.pos_bone_min < 255:
			yield 'pos_bone_to_channel', Array, (0, None, ((instance.arg.pos_bone_max - instance.arg.pos_bone_min) + 1,), name_type_map['Ubyte']), (False, None)
		if instance.arg.ori_bone_min < 255:
			yield 'ori_bone_to_channel', Array, (0, None, ((instance.arg.ori_bone_max - instance.arg.ori_bone_min) + 1,), name_type_map['Ubyte']), (False, None)
		if instance.arg.scl_bone_min < 255:
			yield 'scl_bone_to_channel', Array, (0, None, ((instance.arg.scl_bone_max - instance.arg.scl_bone_min) + 1,), name_type_map['Ubyte']), (False, None)
