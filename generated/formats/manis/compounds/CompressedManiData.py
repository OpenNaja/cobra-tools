...
class CompressedManiData(BaseStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('floatsa', Array, (0, None, (None, None,), Float), (False, None), (None, None))
		yield ('pad_2', SmartPadding, (0, None), (False, None), (None, None))
		yield ('frame_count', Uint, (0, None), (False, None), (None, None))
		yield ('ori_bone_count', Uint, (0, None), (False, None), (None, None))
		yield ('pos_bone_count', Uint, (0, None), (False, None), (None, None))
		yield ('scl_bone_count', Uint, (0, None), (False, None), (None, None))
		yield ('zeros_18', Array, (0, None, (18,), Uint), (False, None), (None, None))
		yield ('count', Ushort, (0, None), (False, None), (None, None))
		yield ('quantisation_level', Ushort, (0, None), (False, None), (None, None))
		yield ('ref_2', Empty, (0, None), (False, None), (None, None))
		yield ('some_indices', Array, (0, None, (None,), Ubyte), (False, None), (None, None))
		yield ('flag_0', Ubyte, (0, None), (False, None), (None, None))
		yield ('flag_1', Ubyte, (0, None), (False, None), (None, None))
		yield ('flag_2', Ubyte, (0, None), (False, None), (None, None))
		yield ('flag_3', Ubyte, (0, None), (False, None), (None, None))
		yield ('anoth_pad', PadAlign, (4, None), (False, None), (None, None))
		yield ('floatsb', FloatsGrabber, (0, None), (False, None), (None, None))
		yield ('extra_pc_zero', Uint64, (0, None), (False, None), (lambda context: context.version <= 257, None))
		yield ('anoth_pad_2', PadAlign, (16, None), (False, None), (None, None))
		yield ('ref_3', Empty, (0, None), (False, None), (None, None))
		yield ('repeats', Array, (0, None, (None,), Repeat), (False, None), (None, None))
