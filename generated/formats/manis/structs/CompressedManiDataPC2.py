...
class CompressedManiDataPC2(BaseStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.u_0 = Array(self.context, 0, None, (0,), name_type_map['Ubyte'])
		...
		self.zend = name_type_map['Ushort'](self.context, 0, None)
	...
	def _get_attribute_list(cls):
		...
		yield 'u_0', Array, (0, None, (4,), name_type_map['Ubyte']), (False, None), (None, None)
		...
		yield 'frame_segments', Array, (0, None, (None,), name_type_map['Uint']), (False, None), (None, True)
		yield 'ff_2', name_type_map['Int'], (0, None), (False, None), (None, True)
		...
		yield 'zend', name_type_map['Ushort'], (0, None), (False, None), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'u_0', Array, (0, None, (4,), name_type_map['Ubyte']), (False, None)
		...
		if instance.frame_segments_count > 1:
		...
		yield 'zend', name_type_map['Ushort'], (0, None), (False, None)
