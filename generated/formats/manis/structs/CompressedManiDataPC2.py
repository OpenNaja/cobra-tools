...
class CompressedManiDataPC2(BaseStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.ori_bone_offset = name_type_map['Uint'](self.context, 0, None)
		self.pos_bone_offset = name_type_map['Uint'](self.context, 0, None)
		self.scl_bone_offset = name_type_map['Uint'](self.context, 0, None)
		...
		self.pos_bones_0 = Array(self.context, 0, None, (0,), name_type_map['Float'])
		self.ori_bones_1 = Array(self.context, 0, None, (0,), name_type_map['Float'])
		self.pos_bones_1 = Array(self.context, 0, None, (0,), name_type_map['Float'])
	...
	def _get_attribute_list(cls):
		...
		yield 'ori_bone_offset', name_type_map['Uint'], (0, None), (False, None), (None, None)
		yield 'pos_bone_offset', name_type_map['Uint'], (0, None), (False, None), (None, None)
		yield 'scl_bone_offset', name_type_map['Uint'], (0, None), (False, None), (None, None)
		...
		yield 'unk_before_floats', name_type_map['Uint'], (0, None), (False, None), (None, None)
		yield 'start_of_floats', name_type_map['Empty'], (0, None), (False, None), (None, None)
		yield 'ori_bones_0', Array, (0, None, (None, 3,), name_type_map['Float']), (False, None), (None, None)
		yield 'pos_bones_0', Array, (0, None, (None, 3,), name_type_map['Float']), (False, None), (None, None)
		yield 'ori_bones_1', Array, (0, None, (None, 3,), name_type_map['Float']), (False, None), (None, None)
		yield 'pos_bones_1', Array, (0, None, (None, 3,), name_type_map['Float']), (False, None), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'ori_bone_offset', name_type_map['Uint'], (0, None), (False, None)
		yield 'pos_bone_offset', name_type_map['Uint'], (0, None), (False, None)
		yield 'scl_bone_offset', name_type_map['Uint'], (0, None), (False, None)
		...
		yield 'unk_before_floats', name_type_map['Uint'], (0, None), (False, None)
		yield 'start_of_floats', name_type_map['Empty'], (0, None), (False, None)
		yield 'ori_bones_0', Array, (0, None, (instance.ori_bone_count, 3,), name_type_map['Float']), (False, None)
		yield 'pos_bones_0', Array, (0, None, (instance.pos_bone_count, 3,), name_type_map['Float']), (False, None)
		yield 'ori_bones_1', Array, (0, None, (instance.ori_bone_count, 3,), name_type_map['Float']), (False, None)
		yield 'pos_bones_1', Array, (0, None, (instance.pos_bone_count, 3,), name_type_map['Float']), (False, None)
