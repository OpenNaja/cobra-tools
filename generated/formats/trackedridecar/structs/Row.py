...
class Row(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.offset_align = name_type_map['Uint'].from_value(0)
		self.seats_count = name_type_map['Uint64'](self.context, 0, None)
		self.seats = name_type_map['ArrayPointer'](self.context, self.seats_count, name_type_map['Vector3'])
		if set_default:
			self.set_defaults()
	...
	def _get_attribute_list(cls):
		...
		yield 'offset_align', name_type_map['Uint'], (0, None), (True, 0), (None, None)
		yield 'seats', name_type_map['ArrayPointer'], (None, name_type_map['Vector3']), (False, None), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'offset_align', name_type_map['Uint'], (0, None), (True, 0)
		yield 'seats', name_type_map['ArrayPointer'], (instance.seats_count, name_type_map['Vector3']), (False, None)
