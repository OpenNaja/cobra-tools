...
class TrackedRideCarRoot(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.attach_joint_name = name_type_map['Pointer'](self.context, 0, name_type_map['ZString'])
		if set_default:
			self.set_defaults()
	...
	def _get_attribute_list(cls):
		...
		yield 'attach_joint_name', name_type_map['Pointer'], (0, name_type_map['ZString']), (False, None), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'attach_joint_name', name_type_map['Pointer'], (0, name_type_map['ZString']), (False, None)
