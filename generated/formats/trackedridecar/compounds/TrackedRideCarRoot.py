...
class TrackedRideCarRoot(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield 'cabin_geometry', name_type_map['Pointer'], (0, name_type_map['ZString']), (False, None), (None, None)
		yield 'cabin_geometry_attach', name_type_map['Pointer'], (0, name_type_map['ZString']), (False, None), (None, None)
