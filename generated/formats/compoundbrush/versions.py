...
class CompoundbrushVersion(VersionBase):

	_file_format = 'compoundbrush'
...
dla = CompoundbrushVersion(id='DLA', version=(15,), primary_games=[], all_games=[games.DISNEYLAND_ADVENTURES])
