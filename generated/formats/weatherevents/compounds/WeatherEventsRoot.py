...
class WeatherEventsRoot(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('resource_name', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('default_event_name', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		...
		yield ('event_list', name_type_map['ArrayPointer'], (None, None), (False, None), (None, None))
