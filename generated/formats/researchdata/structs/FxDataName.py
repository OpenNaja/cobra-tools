...
class FxDataName(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.unk_ptr = name_type_map['Pointer'](self.context, 0, name_type_map['ZString'])
		if set_default:
			self.set_defaults()
	...
	def _get_attribute_list(cls):
		...
		yield 'unk_ptr', name_type_map['Pointer'], (0, name_type_map['ZString']), (False, None), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'unk_ptr', name_type_map['Pointer'], (0, name_type_map['ZString']), (False, None)
