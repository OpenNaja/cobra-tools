...
class AssetpkgRoot(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.shared = name_type_map['Uint64'](self.context, 0, None)
	...
	def _get_attribute_list(cls):
		...
		yield 'shared', name_type_map['Uint64'], (0, None), (False, None), (None, None)

	@classmethod
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		yield from super()._get_filtered_attribute_list(instance, include_abstract)
		yield 'asset_path', name_type_map['Pointer'], (0, name_type_map['ZString']), (False, None)
		yield 'shared', name_type_map['Uint64'], (0, None), (False, None)
