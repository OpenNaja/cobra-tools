...
class BiomeDesignSettingsRoot(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.sandbox_bin_file = name_type_map['Pointer'](self.context, 0, name_type_map['ZString'])
	...
	def _get_attribute_list(cls):
		...
		yield 'sandbox_bin_file', name_type_map['Pointer'], (0, name_type_map['ZString']), (False, None), (None, None)
		yield 'sandbox_world_name', name_type_map['Pointer'], (0, name_type_map['ZString']), (False, None), (None, None)

	@classmethod
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		yield from super()._get_filtered_attribute_list(instance, include_abstract)
		yield 'sandbox_bin_file', name_type_map['Pointer'], (0, name_type_map['ZString']), (False, None)
