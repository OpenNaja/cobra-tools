...
class Event(HircObject):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.action_ids = Array(self.context, 0, None, (0,), name_type_map['Uint'])
		if set_default:
			self.set_defaults()
	...
	def _get_attribute_list(cls):
		...
		yield 'action_ids', Array, (0, None, (None,), name_type_map['Uint']), (False, None), (None, None)

	@classmethod
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		yield from super()._get_filtered_attribute_list(instance, include_abstract)
		yield 'num_actions', name_type_map['Ubyte'], (0, None), (False, None)
		yield 'action_ids', Array, (0, None, (instance.num_actions,), name_type_map['Uint']), (False, None)
