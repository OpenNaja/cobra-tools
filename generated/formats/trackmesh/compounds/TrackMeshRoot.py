...
class TrackMeshRoot(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.offset_data = name_type_map['ArrayPointer'](self.context, self.offset_data_count, name_type_map['OffsetData'])
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'offset_data', name_type_map['ArrayPointer'], (instance.offset_data_count, name_type_map['OffsetData']), (False, None)
