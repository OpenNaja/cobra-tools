...
class LastData(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.models_count = name_type_map['Uint64'](self.context, 0, None)
		...
		self.models = name_type_map['Pointer'](self.context, self.models_count, name_type_map['ZStringList'])
	...
	def _get_attribute_list(cls):
		...
		yield 'models', name_type_map['Pointer'], (None, name_type_map['ZStringList']), (False, None), (None, None)
		yield 'models_count', name_type_map['Uint64'], (0, None), (False, None), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'models', name_type_map['Pointer'], (instance.models_count, name_type_map['ZStringList']), (False, None)
		yield 'models_count', name_type_map['Uint64'], (0, None), (False, None)
