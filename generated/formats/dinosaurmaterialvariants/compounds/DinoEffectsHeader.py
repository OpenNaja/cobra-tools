...
class DinoEffectsHeader(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('vec_0', Vector3F, (0, None), (False, None), (None, None))
		yield ('vec_1', Vector3F, (0, None), (False, None), (None, None))
		yield ('a', Uint, (0, None), (False, None), (None, None))
		yield ('b', Uint, (0, None), (False, None), (None, None))
		yield ('vec_2', Vector3F, (0, None), (False, None), (None, None))
		yield ('vec_3', Vector3F, (0, None), (False, None), (None, None))
		yield ('vec_4', Vector3F, (0, None), (False, None), (None, None))
		yield ('vec_5', Vector3F, (0, None), (False, None), (None, None))
		yield ('c', Uint, (0, None), (False, None), (None, None))
		yield ('d', Uint, (0, None), (False, None), (None, None))
		yield ('floats_1', Array, (0, None, (2,), Float), (False, None), (None, None))
		yield ('e', Uint, (0, None), (False, None), (None, None))
		yield ('floats_2', Array, (0, None, (2,), Float), (False, None), (None, None))
		yield ('f', Uint, (0, None), (False, None), (None, None))
		yield ('floats_3', Array, (0, None, (8,), Float), (False, None), (None, None))
		yield ('g', Uint, (0, None), (False, None), (None, None))
		yield ('floats_4', Array, (0, None, (6,), Float), (False, None), (None, None))
		yield ('h', Uint, (0, None), (False, None), (None, None))
		yield ('floats_5', Array, (0, None, (20,), Float), (False, None), (None, None))
		yield ('i', Uint, (0, None), (False, None), (None, None))
