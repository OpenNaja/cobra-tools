...
import generated.formats.specdef.compound.UnlockState
...
class ResearchStartRoot(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.io_start = 0
		self.count = 0
		self.states = ArrayPointer(self.context, self.count, generated.formats.specdef.compound.UnlockState.UnlockState)
		if set_default:
			self.set_defaults()
	...
	def read_fields(cls, stream, instance):
		...
		instance.states = ArrayPointer.from_stream(stream, instance.context, instance.count, generated.formats.specdef.compound.UnlockState.UnlockState)
