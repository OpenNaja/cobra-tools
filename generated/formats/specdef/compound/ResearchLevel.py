...
class ResearchLevel(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.next_levels = Pointer(self.context, self.next_level_count, generated.formats.specdef.compound.PtrList.PtrList)
		self.children = Pointer(self.context, self.children_count, generated.formats.specdef.compound.PtrList.PtrList)
		if set_default:
			self.set_defaults()
	...
	def read_fields(cls, stream, instance):
		...
		instance.next_levels = Pointer.from_stream(stream, instance.context, instance.next_level_count, generated.formats.specdef.compound.PtrList.PtrList)
		instance.next_level_count = stream.read_uint64()
		instance.children = Pointer.from_stream(stream, instance.context, instance.children_count, generated.formats.specdef.compound.PtrList.PtrList)
