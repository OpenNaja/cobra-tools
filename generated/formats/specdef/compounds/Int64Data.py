...
class Int64Data(MemStruct):
	...
	def read_fields(cls, stream, instance):
		...
		instance.imin = stream.read_int64()
		instance.imax = stream.read_int64()
		instance.ivalue = stream.read_int64()
		instance.ioptional = stream.read_int64()
	...
	def write_fields(cls, stream, instance):
		...
		stream.write_int64(instance.imin)
		stream.write_int64(instance.imax)
		stream.write_int64(instance.ivalue)
		stream.write_int64(instance.ioptional)
		Pointer.to_stream(stream, instance.enum)

	@classmethod
	def _get_filtered_attribute_list(cls, instance):
		yield from super()._get_filtered_attribute_list(instance)
		yield 'imin', Int64, (0, None)
		yield 'imax', Int64, (0, None)
		yield 'ivalue', Int64, (0, None)
		yield 'ioptional', Int64, (0, None)
