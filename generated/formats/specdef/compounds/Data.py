...
class Data(MemStruct):
	...
	_import_key = 'specdef.compounds.Data'
	...
	def _get_attribute_list(cls):
		...
		yield ('dtype', BooleanData, (0, None), (False, None), (None, True))
		yield ('dtype', Int8Data, (0, None), (False, None), (None, True))
		yield ('dtype', Int16Data, (0, None), (False, None), (None, True))
		yield ('dtype', Int32Data, (0, None), (False, None), (None, True))
		yield ('dtype', Int64Data, (0, None), (False, None), (None, True))
		yield ('dtype', Uint8Data, (0, None), (False, None), (None, True))
		yield ('dtype', Uint16Data, (0, None), (False, None), (None, True))
		yield ('dtype', Uint32Data, (0, None), (False, None), (None, True))
		yield ('dtype', Uint64Data, (0, None), (False, None), (None, True))
		yield ('dtype', FloatData, (0, None), (False, None), (None, True))
		yield ('dtype', StringData, (0, None), (False, None), (None, True))
		yield ('dtype', Vector2, (0, None), (False, None), (None, True))
		yield ('dtype', Vector3, (0, None), (False, None), (None, True))
		yield ('dtype', ArrayData, (0, None), (False, None), (None, True))
		yield ('dtype', ChildSpecData, (0, None), (False, None), (None, True))
		yield ('dtype', ReferenceToObjectData, (0, None), (False, None), (None, True))
