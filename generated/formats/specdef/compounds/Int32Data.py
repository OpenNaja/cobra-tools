...
class Int32Data(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('imin', Int, (0, None), (False, None), (None, None))
		yield ('imax', Int, (0, None), (False, None), (None, None))
		yield ('ivalue', Int, (0, None), (False, None), (None, None))
		yield ('ioptional', Int, (0, None), (False, None), (None, None))
