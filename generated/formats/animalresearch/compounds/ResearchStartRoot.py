import generated.formats.animalresearch.compounds.UnlockState
...
class ResearchStartRoot(MemStruct):
	...
	def read_fields(cls, stream, instance):
		...
		instance.states = ArrayPointer.from_stream(stream, instance.context, instance.count, generated.formats.animalresearch.compounds.UnlockState.UnlockState)
	...
	def _get_filtered_attribute_list(cls, instance):
		...
		yield 'states', ArrayPointer, (instance.count, generated.formats.animalresearch.compounds.UnlockState.UnlockState), (False, None)
