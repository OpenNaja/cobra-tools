...
class ResearchStartRoot(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.count = 0
		self.states = ArrayPointer(self.context, self.count, UnlockState)
		if set_default:
			self.set_defaults()
	...
	def read_fields(cls, stream, instance):
		...
		instance.states = ArrayPointer.from_stream(stream, instance.context, instance.count, UnlockState)
	...
	def _get_filtered_attribute_list(cls, instance):
		...
		yield 'states', ArrayPointer, (instance.count, UnlockState), (False, None)
