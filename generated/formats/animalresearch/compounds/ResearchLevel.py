...
class ResearchLevel(MemStruct):
	...
	def _get_filtered_attribute_list(cls, instance):
		...
		yield 'next_levels', Pointer, (instance.next_level_count, generated.formats.animalresearch.compounds.PtrList.PtrList), (False, None)
		yield 'next_level_count', Uint64, (0, None), (False, None)
		yield 'children', Pointer, (instance.children_count, generated.formats.animalresearch.compounds.PtrList.PtrList), (False, None)
