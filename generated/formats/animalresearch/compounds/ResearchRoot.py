...
class ResearchRoot(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.count = 0
		self.levels = ArrayPointer(self.context, self.count, ResearchLevel)
		if set_default:
			self.set_defaults()
	...
	def read_fields(cls, stream, instance):
		...
		instance.levels = ArrayPointer.from_stream(stream, instance.context, instance.count, ResearchLevel)
	...
	def _get_filtered_attribute_list(cls, instance):
		...
		yield 'levels', ArrayPointer, (instance.count, ResearchLevel), (False, None)
