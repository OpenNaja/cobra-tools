...
class TerrainDetailsLayerItem(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('info_list', ArrayPointer, (None, TerrainDetailsLayerItem._import_map["terraindetaillayers.compounds.InfoStruct"]), (False, None), (None, None))
		yield ('info_count', Uint, (0, None), (False, None), (None, None))
		...
		yield ('detail_list', ArrayPointer, (None, TerrainDetailsLayerItem._import_map["terraindetaillayers.compounds.DetailStruct"]), (False, None), (None, None))
		yield ('detail_count', Uint, (0, None), (False, None), (None, None))
		yield ('floata_1', Float, (0, None), (False, None), (None, None))
		yield ('floata_2', Float, (0, None), (False, None), (None, None))
		yield ('floata_3', Float, (0, None), (False, None), (None, None))
		yield ('floata_4', Float, (0, None), (False, None), (None, None))
		yield ('floata_5', Float, (0, None), (False, None), (None, None))
		yield ('floata_6', Float, (0, None), (False, None), (None, None))
		yield ('floata_7', Float, (0, None), (False, None), (None, None))
		yield ('floata_8', Float, (0, None), (False, None), (None, None))
		yield ('unk_3_flags', Uint, (0, None), (False, None), (None, None))
		yield ('unk_4_found_as_1', Uint, (0, None), (False, None), (None, None))
		yield ('unk_5_as_0', Uint, (0, None), (False, None), (None, None))
		yield ('unk_6_as_0', Uint, (0, None), (False, None), (None, None))
		yield ('unk_7_as_0', Uint, (0, None), (False, None), (None, None))
		yield ('unk_8_as_0', Uint, (0, None), (False, None), (None, None))
		yield ('unk_9_as_0', Uint, (0, None), (False, None), (None, None))
		yield ('unk_a_as_0', Uint, (0, None), (False, None), (None, None))
		yield ('unk_b_as_0', Uint, (0, None), (False, None), (None, None))
		yield ('floatb_1', Float, (0, None), (False, None), (None, None))
		yield ('floatb_2', Float, (0, None), (False, None), (None, None))
