...
class State(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('abstract_name', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('concrete_name', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('prefab_name', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		...
		yield ('events_list', name_type_map['Pointer'], (0, None), (False, None), (None, None))
