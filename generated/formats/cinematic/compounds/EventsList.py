...
class EventsList(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.count = 0
		self.events = ArrayPointer(self.context, self.count, Event)
		if set_default:
			self.set_defaults()
	...
	def read_fields(cls, stream, instance):
		...
		instance.events = ArrayPointer.from_stream(stream, instance.context, instance.count, Event)
	...
	def _get_filtered_attribute_list(cls, instance):
		...
		yield 'events', ArrayPointer, (instance.count, Event), (False, None)
