...
class EventAttributes(MemStruct):
	...
	_import_key = 'cinematic.compounds.EventAttributes'
	...
	def _get_attribute_list(cls):
		...
		yield ('anim_name', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('event_name', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('empty_string', name_type_map['Pointer'], (0, None), (False, None), (None, None))
