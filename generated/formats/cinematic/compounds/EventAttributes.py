...
class EventAttributes(MemStruct):
	...
	def _get_filtered_attribute_list(cls, instance):
		...
		yield 'anim_name', Pointer, (0, generated.formats.base.basic.ZString), (False, None)
		yield 'event_name', Pointer, (0, generated.formats.base.basic.ZString), (False, None)
		yield 'empty_string', Pointer, (0, generated.formats.base.basic.ZString), (False, None)
