...
class SupportSetRoot(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('connector_1', ArrayPointer, (None, SupportSetRoot._import_map["path.compounds.Connector"]), (False, None), None)
		yield ('connector_2', ArrayPointer, (None, SupportSetRoot._import_map["path.compounds.ConnectorMultiJoint"]), (False, None), None)
		yield ('pillar', ArrayPointer, (None, SupportSetRoot._import_map["path.compounds.Pillar"]), (False, None), None)
		yield ('footer', ArrayPointer, (None, SupportSetRoot._import_map["path.compounds.Footer"]), (False, None), None)
		yield ('sub_braces', ArrayPointer, (None, SupportSetRoot._import_map["path.compounds.SubBraceStruct"]), (False, None), None)
		...
		yield ('broken_supports', ArrayPointer, (None, SupportSetRoot._import_map["path.compounds.BrokeStruct"]), (False, None), None)
		yield ('data', ArrayPointer, (None, SupportSetRoot._import_map["path.compounds.SupportSetData"]), (False, None), None)
