...
class SupportSetRoot(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.num_subbrace = name_type_map['Uint'](self.context, 0, None)
		self.num_broken_support = name_type_map['Uint'](self.context, 0, None)
		...
		self.footer = name_type_map['ArrayPointer'](self.context, self.num_pillar, name_type_map['Footer'])
		self.sub_braces = name_type_map['ArrayPointer'](self.context, self.num_subbrace, name_type_map['SubBraceStruct'])
		self.broken_supports = name_type_map['ArrayPointer'](self.context, self.num_broken_support, name_type_map['BrokeStruct'])
	...
	def _get_attribute_list(cls):
		...
		yield ('connector_1', name_type_map['ArrayPointer'], (None, None), (False, None), (None, None))
		yield ('connector_2', name_type_map['ArrayPointer'], (None, None), (False, None), (None, None))
		yield ('pillar', name_type_map['ArrayPointer'], (None, None), (False, None), (None, None))
		yield ('footer', name_type_map['ArrayPointer'], (None, None), (False, None), (None, None))
		yield ('sub_braces', name_type_map['ArrayPointer'], (None, None), (False, None), (None, None))
		...
		yield ('num_subbrace', name_type_map['Uint'], (0, None), (False, None), (None, None))
		yield ('num_broken_support', name_type_map['Uint'], (0, None), (False, None), (None, None))
		yield ('unk_floats', Array, (0, None, (4,), name_type_map['Float']), (False, None), (None, None))
		yield ('broken_supports', name_type_map['ArrayPointer'], (None, None), (False, None), (None, None))
		yield ('data', name_type_map['ArrayPointer'], (None, None), (False, None), (None, None))
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'footer', name_type_map['ArrayPointer'], (instance.num_pillar, name_type_map['Footer']), (False, None)
		yield 'sub_braces', name_type_map['ArrayPointer'], (instance.num_subbrace, name_type_map['SubBraceStruct']), (False, None)
		...
		yield 'num_subbrace', name_type_map['Uint'], (0, None), (False, None)
		yield 'num_broken_support', name_type_map['Uint'], (0, None), (False, None)
		yield 'unk_floats', Array, (0, None, (4,), name_type_map['Float']), (False, None)
		yield 'broken_supports', name_type_map['ArrayPointer'], (instance.num_broken_support, name_type_map['BrokeStruct']), (False, None)
