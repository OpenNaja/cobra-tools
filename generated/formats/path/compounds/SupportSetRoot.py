...
class SupportSetRoot(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.has_sub_brace = name_type_map['Uint'](self.context, 0, None)
		...
		self.sub_braces = name_type_map['ArrayPointer'](self.context, 4, name_type_map['SubBrace'])
		self.broken_supports = name_type_map['Pointer'](self.context, 0, name_type_map['BrokeStruct'])
	...
	def _get_attribute_list(cls):
		...
		yield 'sub_braces', name_type_map['ArrayPointer'], (4, name_type_map['SubBrace']), (False, None), (None, None)
		...
		yield 'has_sub_brace', name_type_map['Uint'], (0, None), (False, None), (None, None)
		yield 'unk_floats', Array, (0, None, (4,), name_type_map['Float']), (False, None), (None, None)
		yield 'broken_supports', name_type_map['Pointer'], (0, name_type_map['BrokeStruct']), (False, None), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'sub_braces', name_type_map['ArrayPointer'], (4, name_type_map['SubBrace']), (False, None)
		...
		yield 'has_sub_brace', name_type_map['Uint'], (0, None), (False, None)
		yield 'unk_floats', Array, (0, None, (4,), name_type_map['Float']), (False, None)
		yield 'broken_supports', name_type_map['Pointer'], (0, name_type_map['BrokeStruct']), (False, None)
