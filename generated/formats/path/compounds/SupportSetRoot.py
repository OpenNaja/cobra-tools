...
class SupportSetRoot(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.sub_braces = name_type_map['ArrayPointer'](self.context, self.num_sub_brace, name_type_map['SubBraceStruct'])
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'sub_braces', name_type_map['ArrayPointer'], (instance.num_sub_brace, name_type_map['SubBraceStruct']), (False, None)
