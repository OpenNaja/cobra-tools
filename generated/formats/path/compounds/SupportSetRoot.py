...
class SupportSetRoot(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('sub_braces', name_type_map['ArrayPointer'], (None, name_type_map['SubBraceStruct']), (False, None), (None, None))
		...
		yield ('broken_supports', name_type_map['ArrayPointer'], (None, name_type_map['BrokeStruct']), (False, None), (None, None))
