...
class SubBraceStruct(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.brace_model_0 = name_type_map['Pointer'](self.context, 0, name_type_map['ZString'])
	...
	def _get_attribute_list(cls):
		...
		yield 'brace_model_0', name_type_map['Pointer'], (0, name_type_map['ZString']), (False, None), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'brace_model_0', name_type_map['Pointer'], (0, name_type_map['ZString']), (False, None)
