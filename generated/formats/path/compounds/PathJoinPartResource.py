...
from generated.formats.path.compounds.PointsList import PointsList
from generated.formats.path.compounds.Vector4 import Vector4
...
class PathJoinPartResource(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.num_points_3 = 0
		self.padding_2 = 0
		self.unk_points_1 = Pointer(self.context, self.num_points_1, PointsList)
		self.unk_points_2 = Pointer(self.context, self.num_points_2, PointsList)
		self.unk_vector = ArrayPointer(self.context, 1, Vector4)
		self.unk_shorts = ArrayPointer(self.context, 8, Ushort)
		self.unk_points_3 = Pointer(self.context, self.num_points_3, PointsList)
	...
	def read_fields(cls, stream, instance):
		...
		instance.unk_points_1 = Pointer.from_stream(stream, instance.context, instance.num_points_1, PointsList)
		instance.unk_points_2 = Pointer.from_stream(stream, instance.context, instance.num_points_2, PointsList)
		instance.unk_vector = ArrayPointer.from_stream(stream, instance.context, 1, Vector4)
		instance.unk_shorts = ArrayPointer.from_stream(stream, instance.context, 8, Ushort)
		instance.unk_points_3 = Pointer.from_stream(stream, instance.context, instance.num_points_3, PointsList)
	...
	def _get_filtered_attribute_list(cls, instance):
		...
		yield 'unk_points_1', Pointer, (instance.num_points_1, PointsList), (False, None)
		yield 'unk_points_2', Pointer, (instance.num_points_2, PointsList), (False, None)
		yield 'unk_vector', ArrayPointer, (1, Vector4), (False, None)
		yield 'unk_shorts', ArrayPointer, (8, Ushort), (False, None)
		yield 'unk_points_3', Pointer, (instance.num_points_3, PointsList), (False, None)
