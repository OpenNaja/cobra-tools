...
class MotiongraphHeader(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.m_r_f_member_1 = name_type_map['Pointer'](self.context, 0, None)
	...
	def _get_attribute_list(cls):
		...
		yield 'm_r_f_member_1', name_type_map['Pointer'], (0, None), (False, None), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'm_r_f_member_1', name_type_map['Pointer'], (0, None), (False, None)
