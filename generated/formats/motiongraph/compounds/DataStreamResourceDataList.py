...
from generated.formats.motiongraph.compounds.DataStreamResourceDataPoints import DataStreamResourceDataPoints
...
class DataStreamResourceDataList(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.count = 0
		self.data_stream_resource_data = Pointer(self.context, self.count, DataStreamResourceDataPoints)
		if set_default:
			self.set_defaults()
	...
	def read_fields(cls, stream, instance):
		...
		instance.data_stream_resource_data = Pointer.from_stream(stream, instance.context, instance.count, DataStreamResourceDataPoints)
	...
	def _get_filtered_attribute_list(cls, instance):
		...
		yield 'data_stream_resource_data', Pointer, (instance.count, DataStreamResourceDataPoints), (False, None)
