...
class MGTwo(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.count = 0
		self.ptr = Pointer(self.context, self.count, generated.formats.motiongraph.compounds.PtrList.PtrList)
		if set_default:
			self.set_defaults()
	...
	def _get_filtered_attribute_list(cls, instance):
		...
		yield 'ptr', Pointer, (instance.count, generated.formats.motiongraph.compounds.PtrList.PtrList), (False, None)
