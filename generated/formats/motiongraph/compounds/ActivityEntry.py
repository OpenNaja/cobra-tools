...
class ActivityEntry(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.value = Pointer(self.context, 0, Activity)
		if set_default:
			self.set_defaults()
	...
	def read_fields(cls, stream, instance):
		...
		instance.value = Pointer.from_stream(stream, instance.context, 0, Activity)
	...
	def _get_filtered_attribute_list(cls, instance):
		...
		yield 'value', Pointer, (0, Activity), (False, None)
