...
import generated.formats.motiongraph.compounds.TransStructStopList
...
class State(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.count_2 = 0
		self.activities = Pointer(self.context, self.activities_count, generated.formats.motiongraph.compounds.PtrList.PtrList)
		self.array_2 = Pointer(self.context, self.count_2, generated.formats.motiongraph.compounds.TransStructStopList.TransStructStopList)
	...
	def _get_filtered_attribute_list(cls, instance):
		...
		yield 'activities', Pointer, (instance.activities_count, generated.formats.motiongraph.compounds.PtrList.PtrList), (False, None)
		yield 'count_2', Uint64, (0, None), (False, None)
		yield 'array_2', Pointer, (instance.count_2, generated.formats.motiongraph.compounds.TransStructStopList.TransStructStopList), (False, None)
