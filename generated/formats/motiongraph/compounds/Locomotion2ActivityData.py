...
class Locomotion2ActivityData(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('animations', ArrayPointer, (None, Locomotion2ActivityData._import_map["motiongraph.compounds.Locomotion2AnimationInfo"]), (False, None), (None, None))
		yield ('flags', Uint, (0, None), (False, None), (None, None))
		yield ('stopping_distance', Float, (0, None), (False, 0.0), (None, None))
		yield ('strafe_turn_blend', Float, (0, None), (False, 0.2), (None, None))
		yield ('turn_blend_limit', Float, (0, None), (False, 1.0), (None, None))
		yield ('turn_speed_multiplier', Float, (0, None), (False, 1.0), (None, None))
		yield ('flex_speed_multiplier', Float, (0, None), (False, 1.0), (None, None))
		yield ('blend_space', Locomotion2BlendSpace, (0, None), (False, None), (None, None))
		yield ('output_prop_through_variable', Pointer, (0, ZString), (False, None), (None, None))
		yield ('speed_variable', Pointer, (0, ZString), (False, None), (None, None))
		yield ('orientation_variable', Pointer, (0, ZString), (False, None), (None, None))
		yield ('data_streams_count', Uint64, (0, None), (False, None), (None, None))
		yield ('data_streams', ArrayPointer, (None, Locomotion2ActivityData._import_map["motiongraph.compounds.DataStreamResourceDataList"]), (False, None), (None, None))
