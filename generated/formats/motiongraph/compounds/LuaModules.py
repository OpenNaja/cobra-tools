...
class LuaModules(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('motion_graph', Pointer, (0, ZString), (False, None), (None, None))
		yield ('motion_graph_event_handling', Pointer, (0, ZString), (False, None), (None, None))
		yield ('motion_graph_actions', Pointer, (0, ZString), (False, None), (None, None))
