...
from generated.formats.motiongraph.compounds.CurveDataPoints import CurveDataPoints
...
class CurveData(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.count = 0
		self.points = Pointer(self.context, self.count, CurveDataPoints)
		if set_default:
			self.set_defaults()
	...
	def read_fields(cls, stream, instance):
		...
		instance.points = Pointer.from_stream(stream, instance.context, instance.count, CurveDataPoints)
	...
	def _get_filtered_attribute_list(cls, instance):
		...
		yield 'points', Pointer, (instance.count, CurveDataPoints), (False, None)
