...
class DataStreamResourceDataList(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.io_start = 0
		self.count = 0
		self.data_stream_resource_data = Pointer(self.context, 0, None)
		if set_default:
			self.set_defaults()
	...
	def read_fields(cls, stream, instance):
		...
		instance.data_stream_resource_data = Pointer.from_stream(stream, instance.context, 0, None)
		instance.data_stream_resource_data.arg = 0
