...
class RandomSequenceActivityInfo(MemStruct):

	__name__ = 'RandomSequenceActivityInfo'


	def __init__(self, context, arg=0, template=None, set_default=True):
		super().__init__(context, arg, template, set_default=False)
		self.sequence_index = name_type_map['Uint'](self.context, 0, None)
	...
	def _get_attribute_list(cls):
		...
		yield 'sequence_index', name_type_map['Uint'], (0, None), (False, None), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'sequence_index', name_type_map['Uint'], (0, None), (False, None)
