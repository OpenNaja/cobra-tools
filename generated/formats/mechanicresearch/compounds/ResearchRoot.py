import generated.formats.mechanicresearch.compounds.Research
...
class ResearchRoot(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.count = 0
		self.levels = ArrayPointer(self.context, self.count, generated.formats.mechanicresearch.compounds.Research.Research)
		if set_default:
			self.set_defaults()
	...
	def read_fields(cls, stream, instance):
		...
		instance.levels = ArrayPointer.from_stream(stream, instance.context, instance.count, generated.formats.mechanicresearch.compounds.Research.Research)
