...
class NextResearch(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.unk_1 = 0
		self.item_name = Array((0,), Pointer, self.context, 0, generated.formats.base.basic.ZString)
		if set_default:
			self.set_defaults()
	...
	def _get_filtered_attribute_list(cls, instance):
		...
		yield 'item_name', Array, ((instance.arg,), Pointer, 0, generated.formats.base.basic.ZString), (False, None)
