...
import generated.formats.mechanicresearch.compound.Research
...
class ResearchRoot(MemStruct):
	...
	def read_fields(cls, stream, instance):
		...
		instance.levels = ArrayPointer.from_stream(stream, instance.context, instance.count, generated.formats.mechanicresearch.compound.Research.Research)
	...
	def _get_filtered_attribute_list(cls, instance):
		...
		yield ('levels', ArrayPointer, (instance.count, generated.formats.mechanicresearch.compound.Research.Research))
