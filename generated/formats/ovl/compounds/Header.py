...
class Header(GenericHeader):
	...
	def _get_attribute_list(cls):
		...
		yield ('lod_depth', Uint, (0, None), (False, None), (None, None))
		yield ('len_names', Uint, (0, None), (False, None), (None, None))
		yield ('zero_2', Uint, (0, None), (False, None), (None, None))
		yield ('num_aux_entries', Uint, (0, None), (False, None), (None, None))
		yield ('num_included_ovls', Ushort, (0, None), (False, None), (None, None))
		yield ('num_mimes', Ushort, (0, None), (False, None), (None, None))
		yield ('num_files', Uint, (0, None), (False, None), (None, None))
		yield ('num_files_2', Uint, (0, None), (False, None), (None, None))
		yield ('num_dependencies', Uint, (0, None), (False, None), (None, None))
		yield ('num_archives', Uint, (0, None), (False, None), (None, None))
		yield ('num_pool_groups', Uint, (0, None), (False, None), (None, None))
		yield ('num_pools', Uint, (0, None), (False, None), (None, None))
		yield ('num_datas', Uint, (0, None), (False, None), (None, None))
		yield ('num_buffers', Uint, (0, None), (False, None), (None, None))
		yield ('num_stream_files', Uint, (0, None), (False, None), (None, None))
		yield ('ztuac_unk_0', Uint, (0, None), (False, None), (None, None))
		yield ('ztuac_unk_1', Uint, (0, None), (False, None), (None, None))
		yield ('ztuac_unk_2', Uint, (0, None), (False, None), (None, None))
		yield ('len_archive_names', Uint, (0, None), (False, None), (None, None))
		yield ('num_files_3', Uint, (0, None), (False, None), (None, None))
		yield ('len_type_names', Uint, (0, None), (False, None), (None, None))
		yield ('num_triplets', Uint, (0, None), (False, None), (None, None))
		yield ('reserved', Array, (0, None, (12,), Uint), (False, None), (None, None))
		yield ('names', ZStringBuffer, (None, None), (False, None), (None, None))
		yield ('names_pad', Array, (0, None, (None,), Ubyte), (False, None), (lambda context: context.version <= 15, None))
		yield ('mimes', Array, (0, None, (None,), MimeEntry), (False, None), (None, None))
		yield ('triplets_ref', Empty, (0, None), (False, None), (None, None))
		yield ('triplets', Array, (0, None, (None,), Triplet), (False, None), (lambda context: context.version >= 20, None))
		yield ('triplets_pad', PadAlign, (4, None), (False, None), (lambda context: context.version >= 20, None))
		yield ('files', Array, (0, None, (None,), FileEntry), (False, None), (None, None))
		yield ('archive_names', ZStringBuffer, (None, None), (False, None), (None, None))
		yield ('archives', Array, (0, None, (None,), ArchiveEntry), (False, None), (None, None))
		yield ('included_ovls', Array, (0, None, (None,), IncludedOvl), (False, None), (None, None))
		yield ('dependencies', Array, (0, None, (None,), DependencyEntry), (False, None), (lambda context: context.version >= 19, None))
		yield ('aux_entries', Array, (0, None, (None,), AuxEntry), (False, None), (None, None))
		yield ('dependencies', Array, (0, None, (None,), DependencyEntry), (False, None), (lambda context: context.version <= 18, None))
		yield ('stream_files', Array, (0, None, (None,), StreamEntry), (False, None), (None, None))
		yield ('archives_meta', Array, (0, None, (None,), ArchiveMeta), (False, None), (None, None))
