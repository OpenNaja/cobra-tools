...
class ArchiveEntry(BaseStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('pools_offset', Uint, (0, None), (False, None), (None, None))
		yield ('stream_files_offset', Uint, (0, None), (False, None), (None, None))
		yield ('num_pools', Uint, (0, None), (False, None), (None, None))
		yield ('num_datas', Ushort, (0, None), (False, None), (None, None))
		yield ('num_pool_groups', Ushort, (0, None), (False, None), (None, None))
		yield ('num_buffer_groups', Uint, (0, None), (False, None), (None, None))
		yield ('num_buffers', Uint, (0, None), (False, None), (None, None))
		yield ('num_fragments', Uint, (0, None), (False, None), (None, None))
		yield ('num_root_entries', Uint, (0, None), (False, None), (None, None))
		yield ('read_start', Uint, (0, None), (False, None), (None, None))
		yield ('set_data_size', Uint, (0, None), (False, None), (None, None))
		yield ('compressed_size', Uint, (0, None), (False, None), (None, None))
		yield ('uncompressed_size', Uint64, (0, None), (False, None), (None, None))
		yield ('pools_start', Uint, (0, None), (False, None), (None, None))
		yield ('pools_end', Uint, (0, None), (False, None), (None, None))
		yield ('ovs_offset', Uint, (0, None), (False, None), (None, None))
