...
class TrackStationRoot(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('unk_ints', Array, (0, None, (2,), Uint), (False, None), (None, None))
		yield ('some_dataa', Pointer, (0, TrackStationRoot._import_map["trackstation.compounds.FirstPointersa"]), (False, None), (None, None))
		yield ('some_datab', Pointer, (0, TrackStationRoot._import_map["trackstation.compounds.FirstPointersb"]), (False, None), (None, None))
		yield ('stationpiece_name_0', Pointer, (0, ZString), (False, None), (None, None))
		yield ('stationpiece_name_1', Pointer, (0, ZString), (False, None), (None, None))
		yield ('stationpiece_name_2', Pointer, (0, ZString), (False, None), (None, None))
		yield ('stationpiece_name_3', Pointer, (0, ZString), (False, None), (None, None))
		yield ('stationpiece_name_4', Pointer, (0, ZString), (False, None), (None, None))
		yield ('unk_ints_2', Array, (0, None, (2,), Uint), (False, None), (None, None))
		yield ('stationpiece_name_5', Pointer, (0, ZString), (False, None), (None, None))
		yield ('stationpiece_name_6', Pointer, (0, ZString), (False, None), (None, None))
		yield ('stationpiece_name_7', Pointer, (0, ZString), (False, None), (None, None))
		yield ('unk_floats_2', Array, (0, None, (4,), Float), (False, None), (None, None))
		yield ('unk_ints_3', Array, (0, None, (2,), Uint), (False, None), (None, None))
