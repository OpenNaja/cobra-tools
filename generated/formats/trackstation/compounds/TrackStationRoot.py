...
class TrackStationRoot(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('some_dataa', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('some_datab', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('stationpiece_name_0', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('stationpiece_name_1', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('stationpiece_name_2', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('stationpiece_name_3', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('stationpiece_name_4', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('unk_ints_2', Array, (0, None, (2,), name_type_map['Uint']), (False, None), (None, None))
		yield ('stationpiece_name_5', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('stationpiece_name_6', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('stationpiece_name_7', name_type_map['Pointer'], (0, None), (False, None), (None, None))
