...
class TrackStationRoot(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.unknown_ptr = name_type_map['Uint64'](self.context, 0, None)
		self.unknown_56 = name_type_map['Uint64'](self.context, 0, None)
		self.unknown_64 = name_type_map['Uint64'](self.context, 0, None)
		self.unknown_72 = name_type_map['Uint64'](self.context, 0, None)
	...
	def _get_attribute_list(cls):
		...
		yield 'unknown_ints', Array, (0, None, (2,), name_type_map['Uint']), (False, None), (None, None)
		yield 'unknown_ptr', name_type_map['Uint64'], (0, None), (False, None), (lambda context: context.is_pc_2, None)
		...
		yield 'unknown_56', name_type_map['Uint64'], (0, None), (False, None), (lambda context: context.is_pc_2, None)
		yield 'entrance_gate', name_type_map['Pointer'], (0, name_type_map['ZString']), (False, None), (lambda context: not context.is_pc_2, None)
		yield 'unknown_64', name_type_map['Uint64'], (0, None), (False, None), (lambda context: context.is_pc_2, None)
		yield 'exit_gate', name_type_map['Pointer'], (0, name_type_map['ZString']), (False, None), (lambda context: not context.is_pc_2, None)
		yield 'unknown_72', name_type_map['Uint64'], (0, None), (False, None), (lambda context: context.is_pc_2, None)
		yield 'unk_ints_2', Array, (0, None, (2,), name_type_map['Uint']), (False, None), (lambda context: not context.is_pc_2, None)
		yield 'fence_ext', name_type_map['Pointer'], (0, name_type_map['ZString']), (False, None), (lambda context: not context.is_pc_2, None)
		yield 'small_fence_ext', name_type_map['Pointer'], (0, name_type_map['ZString']), (False, None), (lambda context: not context.is_pc_2, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'unknown_ints', Array, (0, None, (2,), name_type_map['Uint']), (False, None)
		if instance.context.is_pc_2:
			yield 'unknown_ptr', name_type_map['Uint64'], (0, None), (False, None)
		...
		if instance.context.is_pc_2:
			yield 'unknown_56', name_type_map['Uint64'], (0, None), (False, None)
		if not instance.context.is_pc_2:
			yield 'entrance_gate', name_type_map['Pointer'], (0, name_type_map['ZString']), (False, None)
		if instance.context.is_pc_2:
			yield 'unknown_64', name_type_map['Uint64'], (0, None), (False, None)
		if not instance.context.is_pc_2:
			yield 'exit_gate', name_type_map['Pointer'], (0, name_type_map['ZString']), (False, None)
		if instance.context.is_pc_2:
			yield 'unknown_72', name_type_map['Uint64'], (0, None), (False, None)
		if not instance.context.is_pc_2:
