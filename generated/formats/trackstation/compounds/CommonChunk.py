...
class CommonChunk(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('piece_name_0', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('piece_name_1', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('piece_name_2', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('unk_flags_0', Array, (0, None, (8,), name_type_map['Ubyte']), (False, None), (None, None))
		yield ('piece_name_3', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('piece_name_4', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('piece_name_5', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('unk_flags_1', Array, (0, None, (8,), name_type_map['Ubyte']), (False, None), (None, None))
		yield ('piece_name_6', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('piece_name_7', name_type_map['Pointer'], (0, None), (False, None), (None, None))
		yield ('piece_name_8', name_type_map['Pointer'], (0, None), (False, None), (None, None))
