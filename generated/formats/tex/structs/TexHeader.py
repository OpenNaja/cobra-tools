...
class TexHeader(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		# used for texturestreams in DLA
		self.flag = name_type_map['Ubyte'](self.context, 0, None)
		self.flag_x = name_type_map['Ushort'](self.context, 0, None)
		...
		self.pad_dla = name_type_map['Uint'].from_value(0)
	...
	def _get_attribute_list(cls):
		...
		yield 'num_mips', name_type_map['Ubyte'], (0, None), (False, None), (lambda context: context.version <= 15 and not context.is_pc_2, None)
		yield 'flag', name_type_map['Ubyte'], (0, None), (False, None), (lambda context: context.version <= 15 and not context.is_pc_2, None)
		yield 'flag_x', name_type_map['Ushort'], (0, None), (False, None), (lambda context: context.version <= 15 and not context.is_pc_2, True)
		yield 'flag_x', name_type_map['Ushort'], (0, None), (False, None), (lambda context: context.version <= 15 and not context.is_pc_2, True)
		...
		yield 'pad_dla', name_type_map['Uint'], (0, None), (True, 0), (lambda context: context.version <= 15 and not context.is_pc_2, None)
		yield 'pad_dla', name_type_map['Uint'], (0, None), (True, 0), (lambda context: context.version <= 15 and not context.is_pc_2, True)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		if instance.context.version <= 15 and not instance.context.is_pc_2 and instance.flag:
			yield 'flag_x', name_type_map['Ushort'], (0, None), (False, None)
			yield 'flag_x', name_type_map['Ushort'], (0, None), (False, None)
		if instance.context.version <= 15 and not instance.context.is_pc_2:
		...
		if instance.context.version <= 15 and not instance.context.is_pc_2:
			yield 'pad_dla', name_type_map['Uint'], (0, None), (True, 0)
		if instance.context.version <= 15 and not instance.context.is_pc_2 and not instance.flag:
			yield 'pad_dla', name_type_map['Uint'], (0, None), (True, 0)
