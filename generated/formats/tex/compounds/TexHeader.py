...
class TexHeader(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('zero_0', Uint, (0, None), (True, 0), (lambda context: context.version <= 15, None))
		yield ('zero_0', Uint64, (0, None), (True, 0), (lambda context: context.version >= 17, None))
		yield ('zero_1', Uint64, (0, None), (True, 0), (lambda context: context.version >= 19, None))
		yield ('buffer_infos', ArrayPointer, (None, TexHeader._import_map["tex.compounds.TexBufferPc"]), (False, None), (lambda context: 17 <= context.version <= 18, None))
		yield ('buffer_infos', ArrayPointer, (None, TexHeader._import_map["tex.compounds.TexBuffer"]), (False, None), (lambda context: context.version >= 19, None))
		yield ('size_info', Pointer, (0, TexHeader._import_map["tex.compounds.SizeInfo"]), (False, None), (lambda context: context.version >= 19, None))
		yield ('compression_type', DdsTypeCoaster, (0, None), (False, None), (lambda context: context.version <= 18, None))
		yield ('compression_type', DdsType, (0, None), (False, None), (lambda context: context.version >= 19, None))
		yield ('one_0', Ubyte, (0, None), (False, None), (None, None))
		yield ('num_mips', Ushort, (0, None), (False, None), (lambda context: context.version <= 15, None))
		yield ('width', Ushort, (0, None), (False, None), (lambda context: context.version <= 15, None))
		yield ('height', Ushort, (0, None), (False, None), (lambda context: context.version <= 15, None))
		yield ('stream_count', Ubyte, (0, None), (False, None), (lambda context: context.version >= 17, None))
		yield ('stream_count_repeat', Ubyte, (0, None), (False, None), (lambda context: context.version >= 17, None))
		yield ('pad', Uint, (0, None), (True, 0), (None, None))
		yield ('pad_dla', Uint64, (0, None), (True, 0), (lambda context: context.version <= 15, None))
