...
class TexHeader(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('buffer_infos', ArrayPointer, (None, TexHeader._import_map["tex.compounds.TexBufferPc"]), (False, None), True)
		yield ('buffer_infos', ArrayPointer, (None, TexHeader._import_map["tex.compounds.TexBuffer"]), (False, None), True)
		yield ('size_info', Pointer, (0, TexHeader._import_map["tex.compounds.SizeInfo"]), (False, None), True)
