...
class TexHeader(MemStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('buffer_infos', name_type_map['ArrayPointer'], (None, None), (False, None), (lambda context: 17 <= context.version <= 18, None))
		yield ('buffer_infos', name_type_map['ArrayPointer'], (None, None), (False, None), (lambda context: context.version >= 19, None))
		yield ('size_info', name_type_map['Pointer'], (0, None), (False, None), (lambda context: context.version >= 19, None))
