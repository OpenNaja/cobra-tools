...
class Pc2TexBuffer(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.tile_width = name_type_map['Uint'].from_value(512)
	...
	def _get_attribute_list(cls):
		...
		yield 'tile_width', name_type_map['Uint'], (0, None), (False, 512), (None, None)
		yield 'tile_height', name_type_map['Uint'], (0, None), (False, 256), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'tile_width', name_type_map['Uint'], (0, None), (False, 512)
		yield 'tile_height', name_type_map['Uint'], (0, None), (False, 256)
