...
class Pc2TexBuffer(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.weave_width = name_type_map['Uint'].from_value(512)
		self.weave_height = name_type_map['Uint'].from_value(256)
		self.do_weave = name_type_map['Uint'](self.context, 0, None)
	...
	def _get_attribute_list(cls):
		...
		yield 'weave_width', name_type_map['Uint'], (0, None), (False, 512), (None, None)
		yield 'weave_height', name_type_map['Uint'], (0, None), (False, 256), (None, None)
		yield 'do_weave', name_type_map['Uint'], (0, None), (False, None), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'weave_width', name_type_map['Uint'], (0, None), (False, 512)
		yield 'weave_height', name_type_map['Uint'], (0, None), (False, 256)
		yield 'do_weave', name_type_map['Uint'], (0, None), (False, None)
