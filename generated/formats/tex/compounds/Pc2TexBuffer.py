...
class Pc2TexBuffer(MemStruct):
	...
	def __init__(self, context, arg=0, template=None, set_default=True):
		...
		self.enum_related = name_type_map['Ubyte'].from_value(96)
		...
		self.tile_width = name_type_map['Uint'](self.context, 0, None)
		self.tile_height = name_type_map['Uint'](self.context, 0, None)
	...
	def _get_attribute_list(cls):
		...
		yield 'enum_related', name_type_map['Ubyte'], (0, None), (False, 96), (None, None)
		...
		yield 'tile_width', name_type_map['Uint'], (0, None), (False, None), (None, None)
		yield 'tile_height', name_type_map['Uint'], (0, None), (False, None), (None, None)
	...
	def _get_filtered_attribute_list(cls, instance, include_abstract=True):
		...
		yield 'enum_related', name_type_map['Ubyte'], (0, None), (False, 96)
		...
		yield 'tile_width', name_type_map['Uint'], (0, None), (False, None)
		yield 'tile_height', name_type_map['Uint'], (0, None), (False, None)
