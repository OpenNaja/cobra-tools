...
class Header(BaseStruct):
	...
	def _get_attribute_list(cls):
		...
		yield ('header_string', FixedString, (4, None), (False, None), (None, None))
		yield ('size', Uint, (0, None), (False, 124), (None, None))
		yield ('flags', HeaderFlags, (0, None), (False, None), (None, None))
		yield ('height', Uint, (0, None), (False, None), (None, None))
		yield ('width', Uint, (0, None), (False, None), (None, None))
		yield ('linear_size', Uint, (0, None), (False, None), (None, None))
		yield ('depth', Uint, (0, None), (False, 1), (None, None))
		yield ('mipmap_count', Uint, (0, None), (False, None), (None, None))
		yield ('reserved_1', Array, (0, None, (11,), Uint), (False, None), (None, None))
		yield ('pixel_format', PixelFormat, (0, None), (False, None), (None, None))
		yield ('caps_1', Caps1, (0, None), (False, None), (None, None))
		yield ('caps_2', Caps2, (0, None), (False, None), (None, None))
		yield ('caps_3', Uint, (0, None), (False, None), (None, None))
		yield ('caps_4', Uint, (0, None), (False, None), (None, None))
		yield ('unused', Uint, (0, None), (False, None), (None, None))
		yield ('dx_10', Dxt10Header, (0, None), (False, None), (None, True))
