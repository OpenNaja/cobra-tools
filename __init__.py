...
if bpy_available:
	try:
		...
		from plugin.utils.anim import set_fps_from_action_callback
...
def register():
	...
	if set_fps_from_action_callback not in bpy.app.handlers.depsgraph_update_post:
		bpy.app.handlers.depsgraph_update_post.append(set_fps_from_action_callback)
...
def unregister():
	...
	bpy.app.handlers.depsgraph_update_post.remove(set_fps_from_action_callback)
