...
dark_palette.setColor(QtGui.QPalette.Disabled, QtGui.QPalette.ButtonText, DISABLED)
dark_palette.setColor(QtGui.QPalette.Disabled, QtGui.QPalette.WindowText, DISABLED)
dark_palette.setColor(QtGui.QPalette.Disabled, QtGui.QPalette.Text, DISABLED)
dark_palette.setColor(QtGui.QPalette.Disabled, QtGui.QPalette.Light, PRIMARY)
