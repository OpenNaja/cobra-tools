...
class Config(dict):
	...
	lua_flatten = TransientSetting("Flatten LUA subfolders", "Flatten LUA filenames that are in subfolders in injection", False, (True, False))
	lua_unflatten = TransientSetting("Unflatten LUA files", "Unflatten LUA filenames into subfolders on extraction", False, (True, False))
