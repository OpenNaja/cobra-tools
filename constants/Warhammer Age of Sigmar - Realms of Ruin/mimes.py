...
mimes = {
	...
	".audioracedynamicsoundbanks": Mime(name='Game:AudioRaceDynamicSoundbanks:audioracedynamicsoundbanks', hash=3984999186, version=1, triplets=[(1, 2, 3)], pool=4, set_pool=0),
	...
	".colourblindnavdata": Mime(name='Game:ColourBlindNavData:colourblindnavdata', hash=2696825846, version=1, triplets=[(1, 2, 3)], pool=4, set_pool=0),
	...
	".squadarmoury": Mime(name='Game:SquadArmoury:squadarmoury', hash=4217716664, version=1, triplets=[(1, 2, 3)], pool=4, set_pool=0),
	".squaddata": Mime(name='Game:SquadData:squaddata', hash=2530187630, version=1, triplets=[(1, 2, 3)], pool=4, set_pool=0),
	".squadloadout": Mime(name='Game:SquadLoadout:squadloadout', hash=942723306, version=1, triplets=[(1, 2, 3)], pool=4, set_pool=0),
